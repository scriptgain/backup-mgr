        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            @if ($hasIndex)
                <x-card :title="'Select Files (' . count($run->file_index) . ')'">
                    ...
                    <div x-show="viewMode==='list'" class="vx-scroll max-h-[26rem] overflow-y-auto rounded-lg border border-slate-300 bg-slate-50 p-1">
                    ...
                    <div x-show="viewMode==='tree'" class="vx-scroll max-h-[26rem] overflow-y-auto rounded-lg border border-slate-300 bg-slate-50 p-1 text-sm">
