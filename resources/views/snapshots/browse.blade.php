        ...
        <div x-data="{
            ...
            <div class="lg:col-span-2">
                <x-card :title="'Files (' . count($run->file_index) . ')'">
                    ...
                    {{-- List view --}}
                    <div x-show="viewMode==='list'" class="vx-scroll max-h-[28rem] overflow-y-auto -mx-1">
                    ...
                    <div x-show="viewMode==='tree'" class="vx-scroll max-h-[28rem] overflow-y-auto -mx-1 py-1 text-sm">
